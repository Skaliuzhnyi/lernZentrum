    ...
    <main className="min-h-screen pt-16">
      ...
      <section className="relative bg-[#1a3a5c] overflow-hidden" ref={hero.ref}>
        ...
        <div className="relative max-w-4xl mx-auto px-5 py-24 md:py-32 text-center">
          <motion.div initial="hidden" animate={hero.inView ? 'visible' : 'hidden'} variants={stg}>
            ...
            <motion.h1
              variants={fUp}
              className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-[1.08] mb-5"
            >
            ...
            >
              Du hast Freude am Unterrichten und möchtest Schülerinnen und Schüler individuell
              fördern? Dann bist du bei uns genau richtig!
            </motion.p>
      ...
      <section className="py-24 bg-[#fafaf8] px-5" ref={benefits.ref}>
        <div className="max-w-5xl mx-auto">
          <motion.div
            initial="hidden"
            animate={benefits.inView ? 'visible' : 'hidden'}
            variants={stg}
          ...
          >
            ...
            <motion.h2 variants={fUp} className="text-3xl md:text-4xl font-bold text-[#1a3a5c]">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <motion.p variants={fUp} className="text-white/60 text-lg mb-10 leading-relaxed">
              Ob erfahrene Lehrkraft oder engagierter Quereinsteiger – wir freuen uns auf deine
              Bewerbung!
            </motion.p>
            <motion.a variants={fUp} href={WA_LINK} target="_blank" rel="noopener noreferrer">
              <motion.span
